...
class SpawnPoint {
	...
	public function onRoomLoaded() {
		...
		switch (Direction) {
			case 1:
				room.player.direction = FacingDirection.DOWN;
			case 2:
				room.player.direction = FacingDirection.LEFT;
			case 3:
				room.player.direction = FacingDirection.UP;
			case 4:
				room.player.direction = FacingDirection.RIGHT;
		}
		room.player.x = obj.x;
		room.player.y = obj.y;
	}
