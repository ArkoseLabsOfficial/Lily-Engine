...
class Character {
	...
	function create() {
		...
		switch (Direction) {
			case 1:
				characterInstance.direction = FacingDirection.DOWN;
			case 2:
				characterInstance.direction = FacingDirection.LEFT;
			case 3:
				characterInstance.direction = FacingDirection.UP;
			case 4:
				characterInstance.direction = FacingDirection.RIGHT;
		}
